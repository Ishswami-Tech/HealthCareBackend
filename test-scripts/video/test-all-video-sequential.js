/**
 * Sequential Test Runner - All Video Endpoints by Role
 * Runs all role-specific video test suites
 *
 * Run with: node test-scripts/video/test-all-video-sequential.js
 */
...
const roleTests = [
  { name: 'PATIENT', script: 'test-patient-video.js' },
  { name: 'DOCTOR', script: 'test-doctor-video.js' },
  { name: 'RECEPTIONIST', script: 'test-receptionist-video.js' },
  { name: 'CLINIC_ADMIN', script: 'test-clinic-admin-video.js' },
];
...
async function runAllVideoTests() {
  logSection('Running All Video Endpoint Tests by Role');
