/**
 * Sequential Test Runner - All Notification Endpoints by Role
 * Runs all role-specific notification test suites
 *
 * Run with: node test-scripts/notification/test-all-notification-sequential.js
 */
...
const roleTests = [
  { name: 'PATIENT', script: 'test-patient-notification.js' },
  { name: 'DOCTOR', script: 'test-doctor-notification.js' },
  { name: 'RECEPTIONIST', script: 'test-receptionist-notification.js' },
  { name: 'CLINIC_ADMIN', script: 'test-clinic-admin-notification.js' },
];
...
async function runAllNotificationTests() {
  logSection('Running All Notification Endpoint Tests by Role');
