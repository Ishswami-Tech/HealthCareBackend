/**
 * Shared utilities for all API test scripts
 * This is the root-level shared utilities that all service test scripts can use
 */
...
const TEST_USERS = {
  PATIENT: { email: 'patient1@example.com', password: 'test1234' },
  DOCTOR: { email: 'doctor1@example.com', password: 'test1234' },
  RECEPTIONIST: { email: 'receptionist1@example.com', password: 'test1234' },
  CLINIC_ADMIN: { email: 'clinicadmin1@example.com', password: 'test1234' },
  SUPER_ADMIN: { email: 'superadmin@example.com', password: 'test1234' },
};
