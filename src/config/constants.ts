...
export const ENV_VARS = {
  ...
  OPENVIDU_WEBHOOK_ENABLED: 'OPENVIDU_WEBHOOK_ENABLED',
  OPENVIDU_WEBHOOK_ENDPOINT: 'OPENVIDU_WEBHOOK_ENDPOINT',
  OPENVIDU_WEBHOOK_EVENTS: 'OPENVIDU_WEBHOOK_EVENTS',
  // Jitsi Meet Configuration (Fallback)
  JITSI_DOMAIN: 'JITSI_DOMAIN',
  JITSI_BASE_DOMAIN: 'JITSI_BASE_DOMAIN',
  JITSI_SUBDOMAIN: 'JITSI_SUBDOMAIN',
  JITSI_APP_ID: 'JITSI_APP_ID',
  JITSI_APP_SECRET: 'JITSI_APP_SECRET',
  JITSI_BASE_URL: 'JITSI_BASE_URL',
  JITSI_WS_URL: 'JITSI_WS_URL',
  JITSI_ENABLE_RECORDING: 'JITSI_ENABLE_RECORDING',
  JITSI_ENABLE_WAITING_ROOM: 'JITSI_ENABLE_WAITING_ROOM',
