...
- Prisma Studio: ${getEnvironmentConfig().urls.prismaStudio}`
  ...
  .addTag('appointment plugins', 'Appointment plugin system and management')
  .addTag('email', 'Email service and template management')
  .addTag('notifications', 'Push notifications and communication services')
  .addTag('communication', 'Unified communication services (email, WhatsApp, SMS, push)')
  .addTag('video', 'Video consultation services')
  ...
  .addTag('Email Webhooks', 'Email service webhooks (ZeptoMail, SES)')
