export default () => ({
  app: {
    ...
    baseUrl:
      process.env.BASE_URL || `http://localhost:${process.env.PORT || "8088"}`,
    apiUrl:
      process.env.API_URL || `http://localhost:${process.env.PORT || "8088"}`,
  },
  urls: {
  ...
  security: {
    ...
    rateLimitWindowMs: parseInt(
      process.env.SECURITY_RATE_LIMIT_WINDOW_MS || "150",
      10,
    ),
