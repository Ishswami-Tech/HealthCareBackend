  ...
  async register(
    ...
    try {
      ...
      const user = await this.databaseService.createUserSafe({
        ...
        ...(registerDto.area && { area: registerDto.area }),
        ...(registerDto.district && { district: registerDto.district }),
        ...(registerDto.occupation && { occupation: registerDto.occupation }),
        ...(registerDto.organization && { organization: registerDto.organization }),
        role: effectiveRole,
