...
export class AuthController {
  ...
  @ApiBody({
    ...
    description:
      "Refresh token with optional security context for enhanced validation",
    examples: {
      basic: {
  ...
  @ApiBody({
    ...
    description:
      "Password reset request with email and optional clinic context",
    examples: {
      basic: {
  ...
  @ApiBody({
    ...
    description:
      "OTP verification with email, OTP code and optional clinic context",
    examples: {
      verify: {
        summary: "Verify OTP",
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve authenticated user profile information. Cached for performance.",
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all active sessions for the authenticated user. Cached for performance.",
