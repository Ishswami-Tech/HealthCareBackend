...
export class EHRClinicController {
  ...
  async getComprehensiveHealthRecordWithClinic(
    ...
    @Request() req?: ExpressRequest & { user?: { role?: string; id?: string } },
  ) {
  ...
  async getClinicPatientsRecords(
    ...
    @Request() req?: ExpressRequest & { user?: { role?: string } },
  ) {
    ...
    return this.ehrService.getClinicPatientsRecords(clinicId, req?.user?.role || '', filters);
  }
