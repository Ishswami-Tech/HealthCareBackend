...
export const healthcareConfig = registerAs("healthcare", () => ({
  ...
  multiClinic: {
    ...
    maxLocationsPerClinic: parseInt(
      process.env["MAX_LOCATIONS_PER_CLINIC"] || "50",
      10,
    ),
  },
  ...
  database: {
    url:
      process.env["DATABASE_URL"] || "postgresql://localhost:5432/healthcare",
    schema: "healthcare",
    ...
    connectionPool: {
      ...
      readReplicas: {
        ...
        urls: process.env["READ_REPLICA_URLS"]
          ? process.env["READ_REPLICA_URLS"].split(",")
          : [],
      },
      ...
      validation: {
        ...
        query: "SELECT 1",
        interval: parseInt(
          process.env["DB_VALIDATION_INTERVAL"] || "30000",
          10,
        ),
    ...
    queryOptimization: {
      ...
      queryCache: {
        ...
        maxSize: parseInt(
          process.env["DB_QUERY_CACHE_MAX_SIZE"] || "50000",
          10,
        ), // Larger cache
      },
      resultCache: {
        ...
        maxSize: parseInt(
          process.env["DB_RESULT_CACHE_MAX_SIZE"] || "100000",
          10,
        ), // Larger cache
      },
      ...
      circuitBreaker: {
        ...
        failureThreshold: parseInt(
          process.env["DB_CIRCUIT_BREAKER_THRESHOLD"] || "5",
          10,
        ),
        timeout: parseInt(
          process.env["DB_CIRCUIT_BREAKER_TIMEOUT"] || "30000",
          10,
        ),
        resetTimeout: parseInt(
          process.env["DB_CIRCUIT_BREAKER_RESET"] || "60000",
          10,
        ),
      },
    },
    ...
    performance: {
      ...
      memory: {
        ...
        maxConnections: parseInt(
          process.env["DB_MAX_CONNECTIONS"] || "500",
          10,
        ),
      },
      ...
      wal: {
        ...
        keepSegments: parseInt(
          process.env["DB_WAL_KEEP_SEGMENTS"] || "128",
          10,
        ),
        archiveTimeout: parseInt(
          process.env["DB_WAL_ARCHIVE_TIMEOUT"] || "60",
          10,
        ),
      },
      ...
      autoScaling: {
        ...
        cpuThreshold: parseInt(
          process.env["DB_AUTO_SCALING_CPU_THRESHOLD"] || "75",
          10,
        ),
        ...
        scaleUpCooldown: parseInt(
          process.env["DB_SCALE_UP_COOLDOWN"] || "300",
          10,
        ),
        scaleDownCooldown: parseInt(
          process.env["DB_SCALE_DOWN_COOLDOWN"] || "1800",
          10,
        ),
      },
    },
  ...
  cache: {
    ...
    appointmentDataTtl: parseInt(
      process.env["APPOINTMENT_CACHE_TTL"] || "300",
      10,
    ), // 5 minutes
  ...
  security: {
    ...
    rateLimit: {
      ...
      perClinicLimits: {
        ...
        patientSearch: parseInt(
          process.env["RATE_LIMIT_PATIENT_SEARCH"] || "100",
          10,
        ),
        appointmentBooking: parseInt(
          process.env["RATE_LIMIT_APPOINTMENT"] || "50",
          10,
        ),
      },
  ...
  clinic: {
    requireVerification:
      process.env["CLINIC_VERIFICATION_REQUIRED"] === "true" || true,
    maxStaffPerClinic: parseInt(
      process.env["MAX_STAFF_PER_CLINIC"] || "500",
      10,
    ),
    maxPatientsPerClinic: parseInt(
      process.env["MAX_PATIENTS_PER_CLINIC"] || "25000",
      10,
    ), // 10L users across 200 clinics = ~5K avg per clinic
    ...
    locations: {
      ...
      allowOverlapSchedules:
        process.env["ALLOW_OVERLAP_SCHEDULES"] === "true" || false,
    },
  },
  ...
  monitoring: {
    metrics: {
      ...
      retentionPeriod: parseInt(
        process.env["METRICS_RETENTION_PERIOD"] || "604800",
        10,
      ), // 7 days
  ...
  development: {
    ...
    testDatabase: {
      url:
        ...
        "postgresql://localhost:5432/healthcare_test",
