...
export class RepositoryResult<T, E = Error> {
  ...
  unwrap(): T {
    ...
    throw this._error || new Error(`Repository operation failed: ${this._operationType}`);
  }
...
export interface IBaseRepository<TEntity, TCreateInput, TUpdateInput, TId = string> {
   ...
   */
  createMany(data: TCreateInput[], context?: RepositoryContext): Promise<RepositoryResult<TEntity[]>>;

  /**
   * Find entity by ID
   */
  findById(id: TId, context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity | null>>;

  /**
   * Find entity by unique field
   */
  findUnique(where: Record<string, unknown>, context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity | null>>;

  /**
   * Find first entity matching criteria
   */
  findFirst(where: Record<string, unknown>, context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity | null>>;

  /**
   * Find multiple entities
   */
  findMany(context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity[]>>;

  /**
   * Find entities with pagination
   */
  findManyPaginated(context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<PaginatedResult<TEntity>>>;

  /**
   * Update entity by ID
   */
  update(id: TId, data: TUpdateInput, context?: RepositoryContext): Promise<RepositoryResult<TEntity>>;

  /**
   * Update multiple entities
   */
  updateMany(where: Record<string, any>, data: TUpdateInput, context?: RepositoryContext): Promise<RepositoryResult<{ count: number }>>;

  /**
   * Delete entity by ID (hard delete)
   */
  delete(id: TId, context?: RepositoryContext, softDelete?: boolean): Promise<RepositoryResult<TEntity>>;

  /**
   * Delete multiple entities
   */
  deleteMany(where: Record<string, any>, context?: RepositoryContext): Promise<RepositoryResult<{ count: number }>>;
   ...
   */
  count(where?: Record<string, unknown>, context?: RepositoryContext): Promise<RepositoryResult<number>>;

  /**
   * Check if entity exists
   */
  exists(where: Record<string, unknown>, context?: RepositoryContext): Promise<RepositoryResult<boolean>>;

  /**
   * Execute operation in transaction
   */
  executeInTransaction?<T>(operation: (tx: any) => Promise<T>, context?: RepositoryContext): Promise<RepositoryResult<T>>;
}

/**
 * Abstract base repository implementation with common functionality and enterprise patterns
 */
export abstract class BaseRepository<TEntity extends { id: TId }, TCreateInput, TUpdateInput, TId = string> 
  ...
  async create(data: TCreateInput, context?: RepositoryContext): Promise<RepositoryResult<TEntity>> {
    const startTime = Date.now();
  ...
  async createMany(data: TCreateInput[], context?: RepositoryContext): Promise<RepositoryResult<TEntity[]>> {
    const startTime = Date.now();
  ...
  async findById(id: TId, context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity | null>> {
    const startTime = Date.now();
  ...
  async findUnique(where: Record<string, any>, context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity | null>> {
    const startTime = Date.now();
  ...
  async findFirst(where: Record<string, any>, context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity | null>> {
    const startTime = Date.now();
  ...
  async findMany(context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<TEntity[]>> {
    const startTime = Date.now();
  ...
  async findManyPaginated(context?: RepositoryContext, options?: QueryOptions): Promise<RepositoryResult<PaginatedResult<TEntity>>> {
    const startTime = Date.now();
    ...
    try {
      ...
      this.logger.debug(`Finding paginated ${this.entityName}s - page: ${page}, limit: ${limit}`);
      ...
      this.logger.debug(`Found ${entities.length}/${total} ${this.entityName}s`);
  ...
  async update(id: TId, data: TUpdateInput, context?: RepositoryContext): Promise<RepositoryResult<TEntity>> {
    const startTime = Date.now();
  ...
  async updateMany(where: Record<string, any>, data: TUpdateInput, context?: RepositoryContext): Promise<RepositoryResult<{ count: number }>> {
    const startTime = Date.now();
  ...
  async delete(id: TId, context?: RepositoryContext, softDelete: boolean = true): Promise<RepositoryResult<TEntity>> {
    const startTime = Date.now();
    
    try {
      this.logger.debug(`${softDelete ? 'Soft deleting' : 'Deleting'} ${this.entityName}:`, id);
      ...
      this.logger.debug(`${softDelete ? 'Soft deleted' : 'Deleted'} ${this.entityName}:`, entity.id);
  ...
  async deleteMany(where: Record<string, any>, context?: RepositoryContext): Promise<RepositoryResult<{ count: number }>> {
    const startTime = Date.now();
  ...
  async count(where?: Record<string, any>, context?: RepositoryContext): Promise<RepositoryResult<number>> {
    const startTime = Date.now();
  ...
  async exists(where: Record<string, any>, context?: RepositoryContext): Promise<RepositoryResult<boolean>> {
    const startTime = Date.now();
  ...
  async executeInTransaction<T>(
    ...
    try {
      this.logger.debug(`Executing ${this.entityName} operation in transaction`);
   ...
   */
  protected buildQueryOptions(options?: QueryOptions, context?: RepositoryContext): any {
    if (!options) return {};
   ...
   */
  protected getChanges(previous: any, current: any): Record<string, { from: any; to: any }> {
