...
npx prisma generate --schema=./src/libs/infrastructure/database/prisma/schema.prisma --config=./src/libs/infrastructure/database/prisma/prisma.config.js
...
npx prisma migrate deploy --schema=./src/libs/infrastructure/database/prisma/schema.prisma --config=./src/libs/infrastructure/database/prisma/prisma.config.js
...
if [ "$NODE_ENV" = "development" ] || [ "$APP_ENV" = "development" ]; then
  ...
  if [ "$RESET_DB" = "true" ]; then
    ...
    npx prisma migrate reset --force --schema=./src/libs/infrastructure/database/prisma/schema.prisma --config=./src/libs/infrastructure/database/prisma/prisma.config.js
  fi
