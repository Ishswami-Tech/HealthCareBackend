...
import type { SecurityAlertEmailContext } from '@core/types/common.types';
 ...
 */
export function generateSecurityAlertTemplate(context: SecurityAlertEmailContext): string {
  return `
