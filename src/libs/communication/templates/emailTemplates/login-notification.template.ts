...
import type { LoginNotificationEmailContext } from '@core/types/common.types';
 ...
 */
export function generateLoginNotificationTemplate(context: LoginNotificationEmailContext): string {
  return `
