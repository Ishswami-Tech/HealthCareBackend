...
export class WhatsAppConfig {
  ...
  get otpTemplateId(): string {
    return (
      this.configService.get<string>("WHATSAPP_OTP_TEMPLATE_ID") ||
      "otp_verification"
    );
  }
  ...
  get appointmentTemplateId(): string {
    return (
      this.configService.get<string>("WHATSAPP_APPOINTMENT_TEMPLATE_ID") ||
  ...
  get prescriptionTemplateId(): string {
    return (
      this.configService.get<string>("WHATSAPP_PRESCRIPTION_TEMPLATE_ID") ||
