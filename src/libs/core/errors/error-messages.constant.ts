...
export const ErrorMessages: Record<ErrorCode, string> = {
  ...
  [ErrorCode.AUTH_INSUFFICIENT_PERMISSIONS]: 'You do not have sufficient permissions to perform this action.',
  [ErrorCode.AUTH_ACCOUNT_LOCKED]: 'Your account has been temporarily locked due to multiple failed login attempts.',
  ...
  [ErrorCode.USER_PROFILE_INCOMPLETE]: 'Please complete your profile information before proceeding.',
  ...
  [ErrorCode.CLINIC_QUOTA_EXCEEDED]: 'Clinic has exceeded its user quota. Please upgrade your plan.',

  // Appointment Errors
  [ErrorCode.APPOINTMENT_NOT_FOUND]: 'Appointment not found. Please check the appointment ID and try again.',
